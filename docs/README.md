...
| [`01-product/glossary.md`](01-product/glossary.md) | Khái niệm này gọi là gì trong code, và hiện ra sao trên UI… | 🟡 một phần — chỉ những tên đã bị chốt ở doc… | xuất hiện một khái niệm nghiệp vụ mới trong code hoặc UI |
...
| [`design-system/minesweeper/MASTER.md`](design-system/minesweeper/MASTER.md) | Màu nào, chữ nào, khoảng cách nào — và ở đâu là nguồn đúng… | 🟢 đủ | một ADR mới thay quyết định trong ADR-0001 · một feature c… |
